...
const Editor = ({
  ...
  const handleChange = e => {
    ...
    onChangeInput({ name: targetName, value });
  };
  ...
  const fileList = storedFiles.map(file => {
    return (
      <div className={cx('text')} key={file.id}>
        ...
        >
          <g id={file.id} onClick={handleFilterImage}>
            <path
              id={file.id}
              onClick={handleFilterImage}
    ...
    return (
      <div className={cx('text')} key={file.id}>
        ...
        <svg
          ...
          style={{ verticalAlign: 'middle' }}
        >
          <g id={file.id} onClick={handleFilterServerImage}>
            <path
              id={file.id}
              onClick={handleFilterServerImage}
              d="m28.4 26l-6.1-6 6.1-6-2.4-2.4-6 6.1-6-6.1-2.4 2.4 6.1 6-6.1 6 2.4 2.4 6-6.1 6 6.1z m-8.4-22.6c9.2 0 16.6 7.4 16.6 16.6s-7.4 16.6-16.6 16.6-16.6-7.4-16.6-16.6 7.4-16.6 16.6-16.6z"
  ...
  const thumbnailList = (
    <Fragment>
      ...
      <svg
        ...
        style={{ verticalAlign: 'middle' }}
      >
        <g id={thumbnailFiles.id} onClick={handleFilterThumbnail}>
          <path
            id={thumbnailFiles.id}
            onClick={handleFilterThumbnail}
            d="m28.4 26l-6.1-6 6.1-6-2.4-2.4-6 6.1-6-6.1-2.4 2.4 6.1 6-6.1 6 2.4 2.4 6-6.1 6 6.1z m-8.4-22.6c9.2 0 16.6 7.4 16.6 16.6s-7.4 16.6-16.6 16.6-16.6-7.4-16.6-16.6 7.4-16.6 16.6-16.6z"
  ...
  const serverThumbnailList = (
    <Fragment>
      ...
      <svg
        ...
        style={{ verticalAlign: 'middle' }}
      >
        <g id={serverThumbnail.id} onClick={handleFilterServerThumbnail}>
          <path
            id={serverThumbnail.id}
            onClick={handleFilterServerThumbnail}
            d="m28.4 26l-6.1-6 6.1-6-2.4-2.4-6 6.1-6-6.1-2.4 2.4 6.1 6-6.1 6 2.4 2.4 6-6.1 6 6.1z m-8.4-22.6c9.2 0 16.6 7.4 16.6 16.6s-7.4 16.6-16.6 16.6-16.6-7.4-16.6-16.6 7.4-16.6 16.6-16.6z"
    ...
    <div className={cx('editor')}>
      <div className={cx('contents')}>
        <div className={cx('content')}>
          <div className={cx('label')}>시리즈 제목</div>
        ...
        <div className={cx('content')}>
          <div className={cx('label')}>티저 제목(쉼표로 구분)</div>
          <div className={cx('input-wrapper')}>
            <input
              type="text"
              name="teasername"
        ...
        <div className={cx('content')}>
          <div className={cx('label')}>티저 유튜브 Id(쉼표로 구분)</div>
          <div className={cx('input-wrapper')}>
            <input
              type="text"
              name="videoId"
        ...
        <div className={cx('content')}>
          <div className={cx('label')}>배우 이름(쉼표로 구분)</div>
          <div className={cx('input-wrapper')}>
            <input
              type="text"
              name="actorname"
        ...
        <div className={cx('content')}>
          <div className={cx('label')}>배우 이미지 업로드</div>
          <div className={cx('input-wrapper')}>
            {series.size === 0 ? (
              <input
                type="file"
              ...
              <input
                ...
                name="actorImage"
                className={cx('input')}
                ref={actorImageServer =>
                  (this.actorImageServer = actorImageServer)
                }
                style={{ display: 'none' }}
        ...
        <div className={cx('content')}>
          <div className={cx('label')}>줄거리</div>
          <div className={cx('input-wrapper')}>
            <textarea
              name="story"
        ...
        <div className={cx('content')}>
          <div className={cx('label')}>썸네일 이미지 업로드</div>
          <div className={cx('input-wrapper')}>
            {series.size === 0 ? (
              <input
                type="file"
              ...
              <input
                ...
                name="thumbnailImage"
                className={cx('input')}
                ref={thumbnailImageServer =>
                  (this.thumbnailImageServer = thumbnailImageServer)
                }
                style={{ display: 'none' }}
        ...
        <div className={cx('content')}>
          <div className={cx('label')}>장르 (쉼표로 구분)</div>
          <div className={cx('input-wrapper')}>
            <input
              type="text"
              name="genre"
        ...
        <div className={cx('content')}>
          <div className={cx('label')}>시작년도</div>
          <div className={cx('input-wrapper')}>
            <input
              type="text"
              name="startYear"
        ...
        <div className={cx('content')}>
          <div className={cx('label')}>종영 연도</div>
          <div className={cx('input-wrapper')}>
            <input
              type="text"
              name="endYear"
        ...
        <div className={cx('content')}>
          <div className={cx('label')}>첫 방송일(yyyy-MM-dd)</div>
          <div className={cx('input-wrapper')}>
            <input
              type="text"
